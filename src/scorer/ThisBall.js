...
const createRunsButton=(props,score)=>
    <Button color="primary" className="mx-2 my-1 px-3 rounded" style={{flexBasis:40,flexShrink:0, flexGrow:0, width:40}} outline onClick={() => props.selectRunsScored(score)} active={props.selectedRuns === score}>{score}</Button>
